...
class NuevaSalidaScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<NuevaSalidaScreen> createState() =>
      _NuevaSalidaScreenState();
}

class _NuevaSalidaScreenState
    extends ConsumerState<NuevaSalidaScreen> {
...
class _NavigationButtons extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final isLoading = ref
        .watch(preachingDaysNotifierProvider)
        .isLoading;
